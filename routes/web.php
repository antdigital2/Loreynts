...
//        Route::get('/bookmarks/{type}',['uses' => 'BookmarksController@filterBookmarks', 'as'   => 'bookmarks.filter']);
    ...
    Route::group(['prefix' => 'payment', 'as' => 'payment.'], function () {
        ...
        Route::post('/flow/status', ['uses' => 'PaymentsController@verifyFlowTransaction', 'as'   => 'checkFlowPaymentStatus']);
        Route::post('/flow/confirmation', ['uses' => 'PaymentsController@handleFlowPaymentCallback', 'as'   => 'callFlow']);
    });
...
Route::post('payment/flowStatusUpdate', [
    'as'   => 'flow.payment.update',
    'uses' => 'PaymentsController@flowHook',
]);
