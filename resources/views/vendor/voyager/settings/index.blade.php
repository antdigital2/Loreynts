                                    ...
                                    @if($group == 'Emails')
                                        <div class="emails-info">
                                            <div class="alert alert-info alert-dismissible mb-1">
                                                <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                <div class="info-label mb-0"><div class="icon voyager-info-circled"></div> You can use any SMTP you have access to or mailgun API.</div>
                                            </div>
                                        </div>
                                    @endif
                                ...
                                @if($group == 'Payments')
                                    ...
                                    <div class="tab-additional-info">
                                        <div class="payments-info">
                                            ...
                                            <div class="alert alert-info alert-dismissible mb-1 payments-info-flow d-none">
                                                <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                <div class="info-label"><div class="icon voyager-info-circled"></div> In order to use Flow as payment provider you'll need the following endpoint:</div>
                                                <ul>
                                                    <li>Webhook URL: <code>{{route('flow.payment.update')}}</code></li>
                                                </ul>
                                            </div>
