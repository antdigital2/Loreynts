                    ...
                    <div class="modal-body">
                        ...
                        <div>
                            ...
                            <div class="d-flex text-left radio-group row px-2">
                                ...
                                @endif
                                @if(getSetting('payments.flow_api_key') && getSetting('payments.flow_api_secret') && !getSetting('payments.flow_checkout_disabled'))
                                    <div class="p-1 col-6 col-md-3 col-lg-3 col-md-3 flow-payment-method">
                                        <div class="radio mx-auto flow-payment-provider checkout-payment-provider d-flex align-items-center justify-content-center" data-value="flow">
                                            <img src="{{asset('/img/logos/flow.svg')}}">
                                        </div>
                                    </div>
                                @endif
