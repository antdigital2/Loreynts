    ...
    <div class="metrics-container">
        ...
        <div class="row">
            <div class="mb-4 col-md-4">
                <div class="card shadow rounded p-5">
                    <div class="card-body text-muted font-weight-medium">
                        <p class="font-weight-bolder">Últimas 24 horas</p>
            ...
            <div class="mb-4 col-md-4">
                ...
                <div class="card shadow rounded p-5">
                    <div class="card-body text-muted font-weight-medium">
                        <p class="font-weight-bolder">Pagos</p>
            ...
            <div class="mb-4 col-md-4">
                ...
                <div class="card shadow rounded p-5">
                    <div class="card-body text-muted font-weight-medium">
                        <p class="font-weight-bolder">Contenido</p>
        ...
        <div class="row">
            @include('elements.admin.trend_card', [
                ...
                'chart' => [
                    'size' => 100,
                    'color_start' => 'rgba(41, 171, 226)',
                    'color_stop' => 'rgba(255, 0, 255, 0.5)',
                    'border_color' => 'rgba(41, 171, 226, 0.7)',
                    'point_radius' => 10,
                    'total' => true
                ],
