...
$(function () {
    ...
    $('#checkout-center').on('show.bs.modal', function (e) {
        ...
        if (type === 'tip' || type === 'chat-tip') {
            ...
            let showFlowProvider = !app.flowRecurringDisabled;
            ...
            checkout.togglePaymentProvider(showFlowProvider, '.flow-payment-method');
 ...
 */
var checkout = {
    allowedPaymentProcessors: ['stripe', 'paypal', 'credit', 'coinbase', 'nowpayments', 'ccbill', 'paystack', 'oxxo', 'mercado', 'flow'],
    paymentData: {},
    ...
    getSelectedPaymentMethod: function () {
        ...
        const flowProvider = $('.flow-payment-provider').hasClass('selected');
